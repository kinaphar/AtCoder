...
public class Main implements Runnable {
	...
	private void solve(final FastIO io, final String[] args) {
		...
		/*
		 * author: 31536000
		 * AtCoder Beginner Contest 231 C問題
		 * 考察メモ
		 * げー、嫌だなぁ
		 * ライブラリ持ってるとやるだけなんだけどね
		 * ちなみにTreeSet.subSet().size()は計算量が罠、これだからJavaは
		 * Arrays.binarySearchならおっけーだけど、実装めんどい
		 */
		...
		while(Q --> 0) {
			...
			io.println(N - 1 - ACL.MathLib.binarySearch(-1, N, (int i) -> A[i] < x));
		}
	}
